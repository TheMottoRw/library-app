package com.learn.library.fgtit.reader;
...
import com.learn.library.blreader.Register;
...
public class BluetoothReaderService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(Register.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(Register.MESSAGE_DEVICE_NAME);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(Register.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(Register.MESSAGE_READ, bytes, -1, buffer).sendToTarget();
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(Register.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
